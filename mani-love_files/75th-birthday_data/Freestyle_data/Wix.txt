 ...
 * @namespace Events
 */
var Events, custom, es5Shim, es5Sham, base64, polyFills, core, utils, Media, Utils, Styles, Theme, WindowOrigin, WindowPlacement, Base, Error, WixDataCursor, responseHandlers, Billing, Activities, Settings, WixInternalSDK, Contacts, PubSub, Worker, Dashboard, Counters, Wix;
Events = {
  /**
