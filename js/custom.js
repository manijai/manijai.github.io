...
$( function() {
		$('body > section,body > nav,body > div,body > a').not('#counter').addClass('hide');

        var endDate = "December  10, 2015 00:00:00";
        ...
        $('.countdown.styled').countdown({
          ...
          onEnd: function() {
			$('body > section,body > nav,body > div,body > a').not('#counter').removeClass('hide');
          }
        });
